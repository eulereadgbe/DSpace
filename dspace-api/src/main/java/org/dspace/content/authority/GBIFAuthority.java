 ...
 */
public class GBIFAuthority implements ChoiceAuthority, AuthorityVariantsSupport {
    Logger log = LogManager.getLogger(GBIFAuthority.class);
    String gbifurl = "https://api.gbif.org/v1/species";
    ...
    public Choices getMatches(String text, int start, int limit, String locale) {
        ...
        args.add(new BasicNameValuePair("name", text));
        String sUrl = gbifurl + "?" + URLEncodedUtils.format(args, "UTF8") + "&datasetKey=d7dddbf4-2cf0-4f39-9b2a-bb099caae36c";
        try {
            ...
            for(int i=0;i< results.length();i++){
                ...
                String term = result.getString("canonicalName");
                String label = result.getString("canonicalName");
                String authority = result.getString("taxonID");
