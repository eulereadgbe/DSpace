 ...
 */
public class ASFAAuthority implements ChoiceAuthority, AuthorityVariantsSupport {
    Logger log = LogManager.getLogger(ASFAAuthority.class);
    String agrovocurl = "https://agrovoc.fao.org/skosmosAsfa/rest/v1/search";
