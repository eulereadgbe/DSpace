 ...
 *
 */
public class ASFAAuthority implements ChoiceAuthority {

	Logger log = Logger.getLogger(ASFAAuthority.class);
	String agrovocurl = "https://agrovoc.uniroma2.it/skosmosAsfa/rest/v1/search";
	...
	public Choices getMatches(String field, String text, Collection collection, int start, int limit, String locale) {
		...
		try {
			...
			for(int i=0;i< results.length();i++){
				...
				String authority = result.getString("prefLabel");
