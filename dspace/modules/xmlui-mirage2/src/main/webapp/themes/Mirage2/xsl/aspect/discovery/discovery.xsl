            ...
            <div class="col-sm-9 artifact-description">
                ...
                <div class="artifact-info">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test="dri:list[@n=(concat($handle, ':local.seafdecaqd.extract'))]/dri:item">
                            <div class="abstract">
                                <xsl:value-of select="util:shortenString(dri:list[@n=(concat($handle, ':local.seafdecaqd.extract'))]/dri:item[1], 220, 10)"/>
                            </div>
                        </xsl:when>
                    </xsl:choose>
                        ...
                        <span class="publisher-date">
                            <small>
                                <span class="date">
                                    ...
                                    <xsl:value-of select="dri:list[@n=(concat($handle, ':dc.citation.spage'))]"/>
                                    <xsl:if test="dri:list[@n=(concat($handle, ':dc.citation.epage'))]">
                                        <xsl:text>-</xsl:text>
                                        <xsl:value-of select="dri:list[@n=(concat($handle, ':dc.citation.epage'))]"/>
                                    </xsl:if>
                                </span>
                            </small>
                        </span>
