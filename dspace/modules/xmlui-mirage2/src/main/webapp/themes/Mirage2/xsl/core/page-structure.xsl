                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="{$context-path}/" class="navbar-brand">
                            <img src="{$theme-path}images/SEAFDEC-logo.png" />
                        </a>
                        </span>
                        <span class="headerInfoName">SEAFDEC/AQD</span>
                        <span class="headerInfoText">Document Library</span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-4 hidden-print">
                        <div class="pull-right">
                            <span class="theme-by">AQD Digilib is maintained by&#160;</span>
                            <br/>
